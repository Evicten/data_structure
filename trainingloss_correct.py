...
from ae_state_evolution_correct import energetic_potential_MCMC
...
def training_loss_from_order_params(alpha, 
    ...
    energetic = energetic_potential_MCMC(alpha, beta, q_vars, samples, gamma, delta, activation='relu')
...
def main():
    ...
    for i, a in enumerate(a_vals):
        ...
        losses[i] = training_loss_from_order_params(a, q_vars,
